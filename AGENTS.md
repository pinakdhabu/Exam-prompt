...
<!-- SKILLS_TABLE_START -->
<usage>
When users ask you to perform tasks related to SPPU engineering exam preparation, check if any of the available skills below can help complete the task more effectively.
...
<skill>
<name>sppu-subject-prompt-bank</name>
<description>Pre-optimized sample answers for core SPPU subjects (DBMS, OS, CN, DAA). Demonstrates exact structure, keyword placement, and time budgeting for 2/4/6-mark questions.</description>
<location>project</location>
</skill>
