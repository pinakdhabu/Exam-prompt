...
>
> **What we do instead:** The TeX Gyre Termes font family (GFL) is a metric-compatible, freely
> redistributable replacement for Times New Roman. DejaVu fonts replace Arial/Helvetica. If a user's
> system has licensed versions of proprietary fonts (Windows/macOS/Microsoft Office), the renderer
> will prefer system fonts automatically.
>
