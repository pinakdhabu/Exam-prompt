...
> Pattern subject. Predictions based on official syllabus + cross-reference with 2019 Pattern
> Microprocessor PYQs.
...
3. Solve a cache mapping problem: given memory of size X, cache of size Y, block size Z — find
   number of blocks, tag, index, offset bits for direct and set-associative mapping.
...
- **Addressing Modes:** **"IDRIDB"** = Immediate, Direct, Register, Indirect, Indexed, Based,
  Based-Indexed
