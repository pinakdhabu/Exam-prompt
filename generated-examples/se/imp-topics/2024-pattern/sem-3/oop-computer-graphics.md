...
> **SPPU SE Computer Engineering | Semester III | ESE: 70 Marks, CCE: 30 Marks** **⚠️ Note:** 2024
> Pattern subject. Predictions based on official syllabus + cross-reference with 2019 Pattern OOP
> PYQs.
...
6. Explain 2D transformations — translation, scaling, rotation, shear — with matrix representations
   and numerical.
...
- **OOP units (I-III):** Focus on writing clean Java code snippets. Practice exception handling +
  multithreading programs.
- **CG units (IV-V):** Focus on algorithms with numerical traces. Practice drawing matrices for
  transformations.
