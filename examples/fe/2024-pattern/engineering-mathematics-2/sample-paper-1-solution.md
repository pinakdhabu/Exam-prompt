...
**Auxiliary equation:** `m² - 4m + 3 = 0` `(m - 1)(m - 3) = 0` `m = 1, 3`
...
**Auxiliary equation:** `m² + 2m + 1 = 0` `(m + 1)² = 0` `m = -1, -1` (repeated roots)

**CF:** `y_c = (C₁ + C₂x)e^{-x}`

**PI:** Try `y_p = Ae^x`. Substituting: A = 1/4 **PI:** `y_p = (1/4)e^x`
...
**Put x = e^t, then using D operator:** `[D(D-1) - 2D + 2]y = e^{3t}` `[D² - 3D + 2]y = e^{3t}`
...
**Intersection:** (2x-4)² = 4x → 4x² - 16x + 16 = 4x → 4x² - 20x + 16 = 0 → x² - 5x + 4 = 0 → x = 1,
4
...
**(i) L[t³ + 2t² - 3t + 1]:** = 3!/s⁴ + 2·2!/s³ - 3·1/s² + 1/s = **6/s⁴ + 4/s³ - 3/s² + 1/s**

**(ii) L[e^(-t)·sin(2t)]:** Using first shifting: L[sin(2t)] = 2/(s²+4), shift s→(s+1) =
**2/((s+1)² + 4) = 2/(s²+2s+5)**
...
Taking LT: `s²Y - s + 3sY - 3 + 2Y = 0` `(s² + 3s + 2)Y = s + 3`
...
**L⁻¹[s/(s²+1)] = cos(t)** **L⁻¹[1/(s²+4)] = (1/2)sin(2t)**
...
∂φ/∂x = 2xyz + y²z + yz² ∂φ/∂y = x²z + 2xyz + xz² ∂φ/∂z = x²y + xy² + 2xyz

**At (1, -1, 2):** ∇φ = (2×1×(-1)×2 + 1×2 + 1×2², 1²×2 + 2×1×(-1)×2 + 1×2², 1²×(-1) + 1×(-1)² +
2×1×(-1)×2) = (-4+2+4, 2-4+4, -1+1-4) = **(2, 2, -4)**

**Directional derivative in direction (1,2,-1):** Unit vector = (1,2,-1)/√6 D_uφ =
(2,2,-4)·(1,2,-1)/√6 = (2+4+4)/√6 = **10/√6**
...
**LHS (line integral):** C₁: y=0, dy=0, 0→1: ∫x²dx = 1/3 C₂: x=1, dx=0, 0→1: ∫(1+y²)dy = [y+y³/3]₀¹
= 4/3 C₃: y=x, dy=dx, 1→0: ∫[(x²-x²)+(x²+x²)]dx = ∫₂x²dx from 1→0 = -2/3

**LHS = 1/3 + 4/3 - 2/3 = 1**

**RHS (Green's):** ∬(∂Q/∂x - ∂P/∂y)dA where P=x²-y², Q=x²+y²

∂Q/∂x = 2x, ∂P/∂y = -2y ∬(2x + 2y)dA = ∫₀¹∫₀ˣ(2x+2y)dy·dx = ∫₀¹[2xy + y²]₀ˣdx = ∫₀¹3x²dx = 1
