# Exam Prompt Discussions

Welcome to the Exam Prompt community! 🎉
...
3. Be specific about your subject, university, and pattern
...
- `subject:cns` — Computer Networks & Security
- `subject:ai` — Artificial Intelligence
- `subject:dsbda` — Data Science & Big Data Analytics
- `subject:wt` — Web Technology
- `subject:daa` — Design & Analysis of Algorithms
- `subject:ml` — Machine Learning
- `subject:dl` — Deep Learning
- `subject:hpc` — High Performance Computing
- `subject:blockchain` — Blockchain Technology
