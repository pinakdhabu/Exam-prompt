...
1. To understand the fundamental concepts of AI and intelligent agents
2. To study various problem-solving techniques using search algorithms
3. To learn knowledge representation and reasoning methods
4. To explore machine learning and natural language processing basics
5. To understand ethical considerations in AI
...
#### Unit I: Introduction to Artificial Intelligence (09 Hours)

- AI: Definitions, History, Foundations, Applications
...
- Inference in FOL: Unification, Forward/Backward chaining, Resolution
- Structured Knowledge: Frames, Semantic networks, Conceptual graphs
- Planning: STRIPS, Goal stack planning, Partial order planning

#### Unit III: Machine Learning and Probabilistic Reasoning (09 Hours)

- Probability basics, Bayes' theorem, Naive Bayes classifier
- Decision trees, Ensemble methods
- Support Vector Machines basics
- Hidden Markov Models
- Reinforcement learning: Q-learning basics

#### Unit IV: Natural Language Processing and Computer Vision (09 Hours)

- NLP: Syntax/Semantics, POS tagging, Parsing, NER
- Language models: N-grams, Word embeddings
- Computer Vision: Image representation, Feature extraction, Edge detection
- Object recognition basics, CNNs introduction

#### Unit V: AI Ethics and Advanced Topics (09 Hours)

- Ethical AI: Fairness, Accountability, Transparency, Bias
- AI and Society: Employment, Privacy, Security
- Expert Systems: Architecture, Rule-based systems
- Robotics: Configurations, Sensors, Actuators, Localization
- Generative AI: Introduction to LLMs, GANs
...
2. Elaine Rich, Kevin Knight, "Artificial Intelligence", 3rd Edition, Tata McGraw Hill

#### Reference Books

1. Nils J. Nilsson, "Principles of Artificial Intelligence", Morgan Kaufmann
2. Patrick H. Winston, "Artificial Intelligence", 3rd Edition, Addison-Wesley
3. Deepak Khemani, "A First Course in Artificial Intelligence", McGraw Hill

#### MOOC / NPTEL Links

1. NPTEL: Introduction to Artificial Intelligence — IIT Kharagpur
2. NPTEL: AI: Knowledge Representation and Reasoning — IIT Madras
...
1. To understand network architecture, OSI and TCP/IP models
2. To study physical layer transmission media and data link layer protocols
3. To learn network layer protocols, IP addressing, and routing algorithms
4. To explore transport layer protocols and congestion control
5. To understand application layer protocols and network security basics
...
#### Unit I: Introduction and Physical Layer (09 Hours)

- Network Models: OSI, TCP/IP, Protocols, Services, Interfaces
- Physical Layer: Analog/Digital signals, Transmission media (Guided/Unguided)
- Multiplexing: FDM, TDM, WDM, CDM
- Switching: Circuit, Packet, Message switching
- Network Topologies: Star, Bus, Ring, Mesh, Hybrid

#### Unit II: Data Link Layer (09 Hours)

- DLL services: Framing, Flow control, Error control
- Error Detection/Correction: Parity, CRC, Hamming code
- Flow Control: Stop-and-Wait, Sliding Window, Go-Back-N, Selective Repeat
- MAC Sublayer: Random Access (ALOHA, CSMA, CSMA/CD), Controlled Access
- Ethernet: IEEE 802.3, Fast Ethernet, Gigabit Ethernet
- Wireless LAN: IEEE 802.11, Bluetooth

#### Unit III: Network Layer (09 Hours)

- Logical Addressing: IPv4, IPv6, Subnetting, CIDR, VLSM
- Routing Algorithms: Distance Vector (RIP), Link State (OSPF), Path Vector (BGP)
- Network Layer Protocols: ARP, RARP, ICMP, IGMP
- Network Devices: Routers, Switches, Bridges, Gateways
- Software Defined Networking (SDN) basics

#### Unit IV: Transport Layer (09 Hours)

- Transport Services: Connection-oriented/Connectionless
- UDP: Segment format, Checksum
- TCP: Segment format, Connection management, Flow control, Congestion control
- Congestion Control: Slow Start, Congestion Avoidance, Fast Recovery
- Quality of Service: Traffic shaping, Leaky bucket, Token bucket

#### Unit V: Application Layer and Security (09 Hours)

- Application Protocols: HTTP, FTP, SMTP, POP3, IMAP, DNS, DHCP
- Network Security: Cryptography basics, Symmetric/Asymmetric encryption
- Firewalls, VPNs, IDS/IPS
- Web Security: SSL/TLS, HTTPS, SET
...
1. William Stallings, "Data and Computer Communications", 10th Edition, Pearson
2. James F. Kurose, Keith W. Ross, "Computer Networking: A Top-Down Approach", 8th Edition, Pearson

#### MOOC / NPTEL Links

1. NPTEL: Computer Networks — IIT Kharagpur
2. NPTEL: Data Communication and Computer Networks — IIT Madras
...
1. To understand formal languages, grammars, and automata theory
2. To study the equivalence of different automata and language classes
3. To learn about Turing machines and computability
4. To explore complexity theory and NP-completeness
5. To apply automata theory in practical applications
...
#### Unit I: Finite Automata and Regular Languages (09 Hours)

- Deterministic Finite Automata (DFA): Definition, Design, Minimization
- Non-deterministic Finite Automata (NFA): Definition, NFA to DFA conversion
- Regular Expressions: Operations, Algebraic laws, Equivalence to FA
- Closure properties of regular languages
- Pumping Lemma for regular languages

#### Unit II: Context-Free Grammars and Languages (09 Hours)
...
#### Unit III: Pushdown Automata (09 Hours)

- Pushdown Automata: Definition, Types (DPDA, NPDA)
- PDA Design: Acceptance by final state, empty stack
- Equivalence of PDA and CFG
- Deterministic vs Non-deterministic PDA
- Applications of PDA

#### Unit IV: Turing Machines and Computability (09 Hours)

- Turing Machine: Definition, Design, Variants
- TM as a computing device, TM as a language acceptor
- Recursive and Recursively Enumerable languages
- Undecidability: Halting problem, Post's Correspondence Problem
- Rice's Theorem

#### Unit V: Complexity Theory (09 Hours)

- Time Complexity: Big-O, Polynomial time
- P and NP classes: Definitions, Examples
- NP-Completeness: Reduction, Cook-Levin Theorem
- Classic NP-Complete problems: SAT, 3-SAT, Hamiltonian cycle, TSP
- Coping with NP-Completeness: Approximation, Heuristics
...
2. J. C. Martin, "Introduction to Languages and the Theory of Computation", McGraw Hill
3. Dexter C. Kozen, "Automata and Computability", Springer

#### MOOC / NPTEL Links

1. NPTEL: Theory of Computation — IIT Kharagpur
2. NPTEL: Automata Theory — IIT Kanpur
...
1. Implement AI search algorithms for problem solving
2. Develop knowledge representation and reasoning systems
3. Build machine learning models using AI techniques
4. Create NLP and computer vision applications
...
6. Implement decision tree algorithm (ID3/C4.5)
7. Implement Q-learning for a grid world environment
8. Build a simple NLP pipeline (tokenization, POS tagging)
9. Image classification using basic CNN with TensorFlow/PyTorch
10. Mini-project: AI application in any domain

### Learning Resources

#### Tools

- Python, TensorFlow/PyTorch, NLTK, OpenCV, Scikit-learn
...
1. Understand network commands and configuration
2. Configure network devices using Cisco Packet Tracer
3. Implement socket programming and network protocols
4. Analyze network traffic and security
...
1. Study of basic network commands (ping, traceroute, nslookup, ipconfig, netstat)
2. Study of network cables and crimping (RJ45 connectors)
3. Configure VLANs using Cisco Packet Tracer
4. Configure static routing in a network topology
5. Configure dynamic routing using RIP/OSPF
6. Implement a chat application using TCP sockets
7. Implement a file transfer application using UDP
8. Implement a web server using socket programming
9. Analyze HTTP, TCP, and UDP packets using Wireshark
10. Implement RSA encryption algorithm
11. Configure DHCP server and DNS server
12. Configure firewall rules using iptables
13. Implement distance vector routing algorithm
14. Mini-project: Design and simulate a complete network

### Learning Resources

#### Tools

- Cisco Packet Tracer, Wireshark, Python, VirtualBox/VMware
...
1. Understand data warehousing concepts and architecture
2. Study ETL processes and OLAP operations
3. Learn data mining techniques and algorithms
4. Apply clustering and classification techniques
5. Explore data mining applications
...
- Outlier Analysis
- Applications: Web mining, Text mining, Social network analysis
...
2. Study virtualization techniques and cloud architecture
3. Learn cloud storage and data management
4. Explore cloud security and compliance
5. Understand cloud deployment and migration
...
- Cloud Migration: Strategies, Phases, Tools
...
1. Understand fundamental concepts of mobile computing and wireless transmission
2. Study telecommunication systems like GSM and modern cellular standards
3. Analyse mobile network and transport layer protocols
4. Explore mobile databases, data dissemination, and synchronisation
5. Introduce mobile application development frameworks and security challenges
...
1. Understand embedded system architecture and components
2. Study microcontroller programming and interfacing
3. Learn real-time operating system concepts
4. Explore embedded communication protocols
5. Develop embedded system design skills
...
- Case studies: Smart home, Wearable devices
...
1. Understand robotics fundamentals and robot classifications
2. Study robot kinematics and dynamics
3. Learn sensors and actuators used in robotics
4. Explore robot programming and control
5. Understand automation systems and Industry 4.0
...
#### Unit I: Introduction to Robotics (06 Hours)

- Definitions, History, Asimov's Laws
- Robot Anatomy: Joints, Links, End-effectors
- Robot Classifications: Cartesian, Cylindrical, Spherical, Articulated, SCARA
- Robot Specifications: Payload, Reach, Accuracy, Repeatability
- Applications: Manufacturing, Medical, Service, Exploration

#### Unit II: Kinematics and Dynamics (06 Hours)

- Coordinate Systems: World, Joint, Tool frames
- Forward Kinematics: DH parameters, Transformation matrices
- Inverse Kinematics: Analytical and Numerical methods
- Jacobian: Velocity kinematics, Singularities
- Dynamics: Forces, Torques, Lagrange formulation

#### Unit III: Sensors and Actuators (06 Hours)

- Sensors: Proximity, Range, Tactile, Force/Torque, Vision
- Position Sensors: Encoders, Potentiometers, LVDT
- Actuators: DC Motors, Stepper Motors, Servo Motors
- Pneumatic/Hydraulic actuators
- Motor Drivers: H-Bridge, PWM control

#### Unit IV: Robot Programming and Control (06 Hours)

- Programming Methods: Lead-through, Teach pendant, Offline
- Control Architectures: Centralized, Decentralized, Hierarchical
- Trajectory Planning: Joint space, Cartesian space
- PID Control: Position, Velocity control
- Adaptive and Robust control basics

#### Unit V: Automation and Industry 4.0 (06 Hours)

- Automation Types: Fixed, Programmable, Flexible
- Components: PLC, SCADA, HMI
- Industrial Networks: Profibus, EtherCAT, OPC-UA
- Industry 4.0: Cyber-Physical Systems, IIoT, Digital Twin
...
1. John J. Craig, "Introduction to Robotics: Mechanics and Control", 4th Edition, Pearson
2. S. K. Saha, "Introduction to Robotics", 2nd Edition, McGraw Hill
...
# TE Computer Engineering — Semester VI
...
#### Unit I: Fundamentals of Machine Learning (09 Hours)

- Introduction, scope, AI vs ML vs Data Science, traditional programming vs ML
- Real-world applications of ML
- Learning Types: Supervised, unsupervised, semi-supervised, reinforcement
- Models: Geometric, probabilistic, logical, grouping/grading
...
- Regression vs correlation, Univariate/Multivariate regression
- Linear/Nonlinear regression
- Bias-Variance Tradeoff, Overfitting/Underfitting
- Regression Techniques: Simple/Multiple Linear, Polynomial
...
#### Unit III: Supervised Learning — Classification (09 Hours)

- Binary vs Multiclass classification
- Balanced vs Imbalanced problems
- Decision boundary
- Evaluation Metrics: Confusion Matrix, Accuracy, Precision, Recall, F1-Score
- Multiclass strategies: One-vs-One, One-vs-All, Averaging Methods
- Algorithms: K-Nearest Neighbors (KNN), Linear SVM, Soft Margin SVM
...
#### Unit V: Reinforcement Learning (09 Hours)

- Components: Agent, Environment, State, Action, Reward
- Markov Decision Process (MDP): Property, Elements, Tasks
- Framework: Policy, Value functions, Bellman equation
...
3. Shai Shalev-Shwartz, Shai Ben-David, "Understanding Machine Learning", Cambridge University Press

#### MOOC / NPTEL Links

1. NPTEL: Introduction to Machine Learning by Prof. Balaraman Ravindran, IIT Madras
...
1. Understand fundamental principles and challenges of software engineering
2. Study software process models and requirement engineering techniques
3. Apply UML modeling concepts for software design
4. Understand project management and testing concepts
5. Introduce modern and advanced software engineering practices
...
- Definitions, Importance, Software Crisis, Myths/Reality
- Process Framework, SDLC
- Prescriptive Models: Waterfall, V-Model, Incremental
- Evolutionary Models: Prototyping, Spiral, RAD
- Agile Models: Agility, Cost of Change, Extreme Programming, Scrum, Kanban

**Case Study:** Online Examination System

#### Unit II: Requirements Engineering (06 Hours)

- Establishing Groundwork: Stakeholders, Viewpoints, Collaboration
- Non-functional requirements, Traceability
- Elicitation: Gathering, Usage Scenarios, Use Cases, Analysis Model
- Negotiating Requirements: Validation, Management
- SRS Documentation

**Case Study:** College ERP System

#### Unit III: Software Modelling (06 Hours)

- Architecture Principles and Patterns: Layered, Client-Server, Microservices, MVC
- Architecture Documentation: 4+1 view model
- Object Modelling with UML: Basic Concepts
- UML Diagrams: Use Case, Class, Interaction, State Chart, Activity
- Package, Component, Deployment diagrams

**Case Study:** Library Management System

#### Unit IV: Software Project Management and Testing (06 Hours)

- SPM: Complexities, Planning, Metrics
- Estimation Techniques: COCOMO
- Scheduling, Team Structures
- Risk Management, Configuration Management
- Testing: Strategies for Conventional/OO/WebApps
- Validation, System Testing, Debugging, Defect Life Cycle
- Manual vs Automated testing

**Case Studies:** E-Governance Portal (Planning/Estimation), Online Shopping App (Testing)

#### Unit V: Advanced Concepts in Software Engineering (06 Hours)

- Agile/DevOps, CI/CD pipelines
- DevSecOps
- Architecture Patterns: Event-Driven, Serverless, Reactive
- AI in Software Engineering
- Low-Code/No-Code platforms
- Sustainability/Green Computing

**Case Study:** Smart City Service Portal
...
3. Booch, Rumbaugh, Jacobson, "The UML User Guide", Pearson
...
1. Apply feature engineering, implement PCA and LDA for feature reduction
2. Apply multiple linear regression with open-access datasets
3. Provide knowledge of polynomial regression, regularization, and logistic regression
4. Introduce SVM classifiers, K-Means clustering, DBSCAN, ensemble learning, and Q-learning
...
1. Feature Engineering: Handling missing values, encoding categorical variables, scaling attributes
2. Dimensionality Reduction: Applying PCA and LDA on high-dimensional datasets
3. Multiple Linear Regression: Models and performance assessment (MSE, RMSE, R²)
4. Polynomial Regression: Analyzing model complexity and bias-variance trade-off
5. Regularization: Ridge and Lasso regression to address overfitting
6. Logistic Regression: Binary classification with confusion matrix, precision, recall, F1-score
7. SVM: Classifiers with linear/nonlinear kernels and performance comparison
8. K-Means Clustering: Optimal clusters using Elbow or Silhouette methods
9. DBSCAN: Density-based clustering to identify structures and noise
10. Ensemble Learning: Random Forest/Boosting vs baseline models
11. Reinforcement Learning: Q-Learning for Tic-Tac-Toe or Grid World
...
1. Apply software engineering principles to real-world problem statements
2. Develop SRS documents
3. Design and model software systems using UML tools
4. Implement testing strategies and quality assurance techniques
5. Explore Agile practices, version control, and DevOps fundamentals
...
4. Prepare IEEE-format SRS document
5. Requirements Traceability Matrix (RTM) and validation
6. Risk identification and mitigation plan
7. Estimation (LOC/FP), COCOMO, and Gantt chart
...
4. Architectural Design: Layered, Client-Server, Microservices
5. Software Testing: Black Box and White Box test case design
6. Manual and Automated Testing: Selenium WebDriver
...
1. Understand the principles of quantum computing and qubits
2. Study quantum gates and quantum circuits
3. Learn quantum algorithms
4. Explore quantum information theory
5. Understand applications of quantum computing
...
- Current Hardware: Superconducting, Trapped Ion, Photonic
- Programming Frameworks: Qiskit, Cirq, Q#
...
1. Learn fundamentals of distributed systems and architectures
2. Understand communication and synchronization mechanisms
3. Study distributed file systems and naming
4. Explore consistency, replication, and fault tolerance
5. Examine modern advancements in distributed computing
...
- Clock Synchronization: NTP, Lamport, Vector clocks
...
1. Understand user-centered design principles
2. Apply visual and interaction design techniques
3. Perform UX research and usability testing
4. Develop prototypes and wireframes
5. Explore modern industry practices
...
- UX Design Foundations: Information Architecture
...
- AR/VR/MR UX: Spatial interfaces
- Industry-specific UX: Healthcare, Finance, Education
...
1. Understand the role of system software and language processors
2. Study assemblers, macroprocessors, loaders, and linkers
3. Learn lexical and syntax analysis for compilers
4. Explore compiler phases and interpreter design
5. Understand debugging tools
...
- Machine-Independent Features: Literals, Symbol-defining statements, Expressions
- MASM Assembler
...
- Linker: Relocation, Linking concepts
- Dynamic Linking
...
- Syntax Analysis: CFG, Parse trees
...
- Code Generation
- Interpreters: Pure, Bytecode
- Debuggers: Features, Breakpoints, Symbolic debugging
...
1. Understand IR concepts and text processing
2. Study indexing structures and query processing
3. Learn evaluation of IR systems
4. Explore web search and multimedia retrieval
5. Understand recent trends in IR
...
2. Study computational statistics
3. Learn data modeling techniques
4. Explore text analytics
5. Understand recent advances in data visualization
...
2. Study classical and modern encryption techniques
3. Learn authentication, digital signatures, and key management
4. Explore security protocols
5. Understand real-world security mechanisms
...
1. Study advanced DBMS architectures
2. Learn query processing and optimization
3. Understand transaction management and concurrency
4. Explore advanced database models
...
1. Understand environmental IT impacts
2. Explore sustainable infrastructure
3. Analyze energy efficiency
4. Apply Green IT policies and AI techniques for sustainability
...
#### Unit I: Fundamentals of Green Computing (03 Hours)

- Environmental impacts of IT
- E-waste management: Generation, Handling, Recycling
- Green IT strategies
- Business/IT relationship in sustainability

#### Unit II: Green Assets and Infrastructure (03 Hours)

- Green buildings and data centers
- Enterprise architecture for sustainability
- Green information systems design

#### Unit III: Data Center Sustainability (03 Hours)

- PUE metrics, Power efficiency
- Virtualization for energy efficiency
- Cooling techniques: Air, Liquid
- Renewable energy integration

#### Unit IV: Compliance and AI for Sustainability (03 Hours)

- Regulations: WEEE, RoHS, Energy Star
- AI for sustainable computing: Monitoring, Prediction, Resource optimization
- Green AI: Energy-efficient ML models

### Learning Resources

#### Text Books

1. H. Geng, "Green Computing: Practices and Strategies", Wiley
2. Murugesan & Gangadharan, "Harnessing Green IT: Principles and Practices"
3. Unhelkar, "Green IT Strategies and Applications"
...
1. Safely install and commission solar PV systems
2. Analyze environmental impacts on efficiency
3. Evaluate maintenance and troubleshooting procedures
4. Develop solutions via mini-projects
...
- I-V/P-V characteristics of solar panels
- Comparative analysis of configurations: Grid-Tied, Hybrid, Off-Grid
- Series/parallel connections
- System wiring and preventive maintenance
- Inverter health and fault diagnosis
- Mounting structure design
- IoT-based monitoring of solar systems

### Learning Resources

#### Text Books

1. Sukhatme, "Solar Energy: Principles of Thermal Collection and Storage"
2. Solanki, "Solar Photovoltaic Technology and Systems"
3. Kothari et al., "Renewable Energy Sources"
...
1. Expose students to industry practices
2. Bridge academic and practical knowledge gaps
3. Build professional competency and ethics
4. Foster innovation and research mindset
...
1. King & Skakoon, "The Unwritten Laws of Engineering"
2. Walesh, "Engineering Your Future"
3. Goldratt, "The Goal"
4. AICTE Internship Policy and Portal
