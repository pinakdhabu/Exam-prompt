...
function resolveFontFile(filenames) {
  const possibleDirs = [
    ...
    path.join(__dirname, '../../fonts/noto-sans-bengali'),
    path.join(__dirname, '../../fonts/noto-sans-gujarati'),
    path.join(__dirname, '../../fonts/noto-sans-gurmukhi'),
    path.join(__dirname, '../../fonts/noto-sans-tamil'),
    path.join(__dirname, '../../fonts/noto-sans-telugu'),
    path.join(__dirname, '../../fonts/noto-sans-kannada'),
    path.join(__dirname, '../../fonts/noto-sans-malayalam'),
    path.join(__dirname, '../../fonts/noto-sans-oriya'),
    path.join(__dirname, '../../fonts/noto-sans-sinhala'),
    path.join(__dirname, '../../fonts/noto-sans-arabic'),
    path.join(__dirname, '../../fonts/noto-sans-hebrew'),
    path.join(__dirname, '../../fonts/noto-sans-thai'),
    path.join(__dirname, '../../fonts/noto-sans-lao'),
    path.join(__dirname, '../../fonts/noto-sans-khmer'),
    path.join(__dirname, '../../fonts/noto-sans-myanmar'),
    path.join(__dirname, '../../fonts/noto-sans-cjk-sc'),
    path.join(__dirname, '../../fonts/noto-sans-cjk-tc'),
    path.join(__dirname, '../../fonts/noto-sans-cjk-jp'),
    path.join(__dirname, '../../fonts/noto-sans-cjk-kr'),
    path.join(__dirname, '../../fonts/noto-sans-cjk-hk'),
    path.join(__dirname, '../../fonts/noto-sans-armenian'),
    path.join(__dirname, '../../fonts/noto-sans-georgian'),
    path.join(__dirname, '../../fonts/noto-sans-ethiopic'),
  ];
