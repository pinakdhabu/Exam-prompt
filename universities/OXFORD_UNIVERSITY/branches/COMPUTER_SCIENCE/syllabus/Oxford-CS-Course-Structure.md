# Oxford University Computer Science — Course Reference
...
- Recursion, higher-order functions, types, monads
...
- Computer arithmetic, processor design
...
- Graph theory: trees, bipartite graphs, planarity
- Combinatorics, counting
- Number theory and modular arithmetic

---

## Year 2: Core and Optional Courses
...
## Year 3: Advanced Options

Students choose 6-8 advanced options from 30+ available courses including:
...
## Year 4: Research Project + Advanced Options

- **Research Project** (full unit): Year-long supervised research project
- **6-7 Advanced Options** from the Year 3 list
- Project counts as 3 units of the total 8 required
