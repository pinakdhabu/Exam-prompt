...
## 410703: Mixed Reality and Immersive Technologies
...
- Magic Leap: Photonics, Lightfield, Interactions
- Apple Vision Pro: VisionOS, Eye Tracking, Passthrough
...
- Eye Tracking: Pupil Center Corneal Reflection, Video-oculography
- Gaze Interaction: Dwell, Target Selection, Foveated Rendering
- Eye Tracking Applications: Avatar Animation, Attention Analysis
...
- Mesh Processing: Simplification, Hole Filling, Texturing
- Object Placement: Physics, Occlusion, Collision
...
- Heart Rate and HRV: Stress Detection
- Biosensor Data Fusion: Multimodal Affective Computing
...
- AI Avatars: Face Generation, Voice Cloning, Animation
- Digital Humans: MetaHuman, Real-time Facial Animation
...
- Volumetric Holography: Principles, Displays
- Eye-tracked Foveated Rendering: Pipeline, Benefits
- XR in Enterprise: Training, Simulation, Collaboration
- XR Ethics: Accessibility, Addiction, Privacy, Misinformation
...
## 410704: Mixed Reality Laboratory

**Teaching Scheme:** Practical: 02 Hours/Week | **Credits:** 01 | **TW:** 25, **PR:** 25

### Laboratory Experiments

1. Set up MRTK (Mixed Reality Toolkit) for HoloLens
2. Implement spatial mapping and place holograms on real surfaces
3. Implement hand tracking with gesture recognition
4. Implement eye tracking interaction (dwell to select)
5. Build multi-user shared holographic experience with anchors
6. Implement 3D scanning with LiDAR and mesh import
7. Build AI-powered virtual assistant using LLM integration
8. Implement voice commands for XR interaction
9. Optimize MR experience for spatial mapping performance
10. Mini-project: Complete MR application for enterprise/training
