...
**Teaching Scheme:** Theory: 03 Hours/Week | **Credits:** 03 | **Examination:** ISA: 30, ESA: 70
...
- Apply statistical methods for data-driven insights
...
- Data Sources: APIs, Web Scraping, Databases, Log Files
...
- Feature Engineering: Creating, Selecting, Transforming Features
...
- Outlier Detection: IQR, Z-Score, Visualization Methods
...
- Storytelling with Data: Narrative, Context, Audience
...
- Network Visualization: Node-Link Diagrams, Adjacency Matrices
- Hierarchical Data Visualization: Treemaps, Sunburst Charts
...
- Reproducible Research: Jupyter Notebooks, R Markdown
- Data Science Ethics: Privacy, Bias, Transparency
...
**Teaching Scheme:** Practical: 02 Hours/Week | **Credits:** 01 | **Examination:** TW: 25, PR: 25

### Laboratory Experiments

1. Python data science environment setup (NumPy, Pandas, Matplotlib)
2. Data wrangling: Load, clean, and transform datasets using Pandas
3. Exploratory data analysis on a real-world dataset with descriptive statistics
4. Create static visualizations: bar charts, scatter plots, histograms, box plots
5. Create multivariate visualizations: pair plots, correlation heatmaps
6. Time series visualization and analysis
7. Geospatial data visualization using Folium/Plotly
8. Build an interactive dashboard using Plotly Dash/Tableau
9. Perform web scraping and data analysis
10. Mini-project: Complete data science analysis with visualization report
