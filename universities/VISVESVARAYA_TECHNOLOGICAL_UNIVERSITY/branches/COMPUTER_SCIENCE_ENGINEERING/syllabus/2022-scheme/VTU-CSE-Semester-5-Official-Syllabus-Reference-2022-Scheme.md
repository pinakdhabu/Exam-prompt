# VTU Fifth Semester Computer Science & Engineering — Official Syllabus Reference (2022 Scheme)
...
- BCS515E: Unix System Programming
- BCS515F: Digital Image Processing

---

## BCS501: Software Engineering & Project Management

**Teaching Scheme:** Theory: 03 Hours/Week | **Credits:** 03 | **Total Hours:** 45
...
**Textbook 1:** Ch. 1 (1.1 to 1.6), Ch. 2 (2.1 to 2.5)
...
**Textbook 1:** Ch. 5 (5.1 to 5.7), Ch. 6 (6.1 to 6.5), Ch. 7 (7.1 to 7.3)

#### Module 3: Agile Development (10 Hours)
...
**Textbook 1:** Ch. 3 (3.1 to 3.6), Ch. 4 (4.1 to 4.3)
...
**Textbook 2:** Ch. 1 (1.1 to 1.17), Ch. 2 (2.4 to 2.6)
...
**Textbook 2:** Ch. 13 (13.1 to 13.5, 13.7, 13.8), Textbook 1: Ch. 26 (26.5 to 26.7)
...
2. Hans van Vliet, "Software Engineering: Principles and Practice", 3rd Edition, Wiley India, 2010

---

## BCS502: Computer Networks (IPCC)

**Teaching Scheme:** Theory: 03 Hours/Week, Practical: 02 Hours/Week

**Credits:** 04 (Theory 3 + Practical 1) | **Total Hours:** 40 Theory + 8-10 Lab Slots
...
#### Module 3: Network Layer (08 Hours)

- Network Layer Services
- Packet Switching
- IPv4 Address: Classful, Classless Addressing
...
#### Module 4: Transport Layer (08 Hours)

- Introduction to Transport Layer
- Transport Layer Protocols
- User Datagram Protocol (UDP): Segment Format, Applications
- Transmission Control Protocol (TCP): Services, Features, Segments
- TCP Connections: Establishment, Termination
- TCP Flow Control: Sliding Window
- TCP Error Control: Acknowledgment, Retransmission
...
#### Module 1: Finite Automata (10 Hours)
...
**Textbook:** Sections 1.1, 1.5, 2.2, 2.3, 2.4, 2.5

#### Module 2: Regular Expressions and Languages (10 Hours)
...
**Textbook:** Sections 3.1, 3.2 (Except 3.2.1), 3.3, 4.1, 4.2, 4.4

#### Module 3: Context-Free Grammars and Pushdown Automata (10 Hours)
...
**Textbook:** Sections 5.1, 5.2, 5.4, 6.1, 6.2, 6.3.1, 6.4

#### Module 4: Normal Forms and Pumping Lemma (10 Hours)

- Normal Forms for Context-Free Grammars: Chomsky Normal Form (CNF), Greibach Normal Form (GNF)
...
**Textbook:** Sections 8.1, 8.2, 8.3, 8.4, 9.1, 9.2
...
1. Create a basic HTML page with text formatting, images, and hyperlinks
2. Design HTML forms with various input types and validation
3. Style web pages using CSS (inline, internal, external)
4. Implement responsive design using CSS flexbox/grid
5. Write JavaScript programs for form validation
6. Implement DOM manipulation using JavaScript
7. Create AJAX requests for asynchronous data loading
8. Develop a PHP server-side script for form processing
9. Build a database-driven web application using MySQL
10. Create a full-stack mini-project (e.g., Blog, E-commerce catalog)

---

## BCS515A: Data Science (Professional Elective)
...
- Understand data science lifecycle and data preparation
- Learn statistical analysis and inference techniques
- Study machine learning algorithms for data analysis
- Explore data visualization and communication
...
#### Module 4: Machine Learning for Data Science
...
#### Module 5: Big Data and Visualization
...
## BCS515B: Full Stack Development (Professional Elective)
...
- Learn front-end frameworks and tools
...
1. David Flanagan, "JavaScript: The Definitive Guide", 7th Edition, O'Reilly, 2020
2. Ethan Brown, "Web Development with Node and Express", 2nd Edition, O'Reilly, 2019

#### Reference Books

1. Adam Scott, "Full Stack Web Development with React", O'Reilly, 2020
...
**Textbook:** Ch. 1.1, 1.4, 1.5, 5.1-5.5
...
**Textbook:** Ch. 12.1, 12.2, 13.1-13.3

#### Module 3: Time and Global States (08 Hours)

- Introduction
- Clocks, Events and Process States
- Synchronizing Physical Clocks: NTP
- Logical Time and Logical Clocks: Lamport, Vector Clocks
- Global States: Distributed Snapshots

**Textbook:** Ch. 14.1-14.5

#### Module 4: Coordination and Agreement (08 Hours)

- Introduction
- Distributed Mutual Exclusion: Centralized, Distributed, Token Ring
- Elections: Bully, Ring Algorithms
- Coordination and Agreement in Group Communication
- Consensus and Related Problems: Paxos, Raft

**Textbook:** Ch. 15.1-15.5
...
## BCS515E: Unix System Programming (Professional Elective)
...
- Understand Unix architecture, commands, and shell programming
- Learn file I/O, process control, and interprocess communication
- Study signals and daemon processes
...
#### Module 1: Unix Fundamentals (08 Hours)
...
- File Commands: cat, mv, rm, cp, wc, od

**Textbook 1:** Ch. 1, 2, 3, 4, 5
...
- Logical Operators
- test command, if, while, for, case Control Statements
- set, shift commands
- here (<<) document and trap command

**Textbook 1:** Ch. 6, 8, 13, 14
...
- Shared Memory, Client-Server Properties

**Textbook 2:** Ch. 8, 15, 17
...
- Signal Sets: sigprocmask, sigpending, sigaction
...
## BCS508: Environmental Studies & E-Waste Management

**Teaching Scheme:** Theory: 02 Hours/Week | **Credits:** 02 | **Total Hours:** 25
...
#### Module 3: Environmental Pollution (05 Hours)

- Water Pollution: Sources, Impacts, Preventive Measures
- Noise Pollution: Sources, Effects, Control
- Air Pollution: Sources, Impacts, Preventive Measures and Public Health Aspects
...
2. R.E. Hester, R.M. Harrison, "Electronic Waste Management", Science, 2009
...
## BCSK507: Creativity and Innovation

**Teaching Scheme:** Practical: 02 Hours/Week | **Credits:** 01

**Examination:** CIE: 100 Marks, SEE: None, Total: 100 Marks

### Course Objectives

- Foster creative thinking and innovation skills
- Develop problem-solving abilities through design thinking
...
- Innovation Showcase / Pitch Presentation
